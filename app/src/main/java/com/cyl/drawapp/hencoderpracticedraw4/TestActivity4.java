package com.cyl.drawapp.hencoderpracticedraw4;
...
public class TestActivity4 extends AppCompatActivity {
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_camera_rotate_fixed, R.string.title_camera_rotate_fixed, R.layout.practice_measure_text_4));
